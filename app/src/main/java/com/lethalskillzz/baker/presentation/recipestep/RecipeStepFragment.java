...
import com.lethalskillzz.baker.presentation.base.BaseFragment;
...
import com.lethalskillzz.baker.di.component.ActivityComponent;
...
public class RecipeStepFragment extends BaseFragment implements RecipeStepMvpView, ExoPlayer.EventListener {
    ...
    public static RecipeStepFragment newInstance(Step step) {
        ...
        args.putParcelable(AppConstants.BUNDLE_STEP_DATA, step);
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if ((arguments != null) && (arguments.containsKey(AppConstants.BUNDLE_STEP_DATA))) {
            mStep = arguments.getParcelable(AppConstants.BUNDLE_STEP_DATA);
        }
    }
