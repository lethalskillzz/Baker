package com.lethalskillzz.baker.utils;

import android.content.ContentValues;
import android.database.Cursor;
import android.support.annotation.NonNull;

import com.lethalskillzz.baker.data.local.db.IngredientPersistenceContract.IngredientEntry;
import com.lethalskillzz.baker.data.local.db.RecipePersistenceContract.RecipeEntry;
import com.lethalskillzz.baker.data.local.db.StepPersistenceContract.StepEntry;
